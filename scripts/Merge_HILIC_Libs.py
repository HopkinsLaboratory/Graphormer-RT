...
with open(r'/home/cmkstien/Desktop/RT_data/filtered_July31/HILIC_filt_list_july31.csv', 'r') as file:
...
with open('/home/cmkstien/Desktop/RT_data/rt_HILIC_July31.csv', 'w') as file:
...
for root, dirs, files in os.walk(path):
    for dir in dirs:
        ...
        ## TODO: Figure out if it makes sense to switch these. Go from organic to aqueous or low to high concetration. 
        ## Also make sure you're getting all the correct inflecction points
        ...
        if len(inflections) >= 4:
            print('TOO MANY INFLECTIONS', dir, n_rts)
            continue
        ...
        total += n_rts
        # print(column_params, dir)
        # continue
        n_met += 1
        with open('/home/cmkstien/Desktop/RT_data/HILIC/rt_data_Aug12_HILIC.csv', 'a') as file:
    ...
    with open('/home/cmkstien/Desktop/RT_data/HILIC/HILIC_metadata.pickle', 'wb') as file:
