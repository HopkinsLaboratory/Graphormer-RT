...
grad_path = '/home/cmkstien/Graphormer_RT/HuanLab/HILIC_gradient.tsv'
...
with open('/home/cmkstien/Graphormer_RT/HuanLab/HILIC_huan_column_params.pkl', 'wb') as f:
    pickle.dump(column_params, f)
